...
def test_if_quote_return_string_when_success(mocker, api_key_mock_local):
    ...
    # Mock the get_api_key function to run locally
...
def test_log_error_when_function_return_400(mocker, caplog, api_key_mock_local):
...
def test_if_data_is_none_will_not_save_to_storage_and_let_user_know(
    caplog, mock_authentication_databricks
):
